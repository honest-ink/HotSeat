...
const ANCHOR_IMG =
  "https://raw.githubusercontent.com/honest-ink/HotSeat/a3d4c3352b95f9b13bd841806f882334f792a522/NewsAnchor2.png";
  ...
  return (
    <div className="absolute inset-0 bg-[#050510] overflow-hidden -z-10 [perspective:1000px]">
      ...
      >
        ...
        <div
          className={`absolute inset-0 bg-gradient-to-t ${ambientColor} via-transparent to-black/90 mix-blend-overlay transition-colors duration-1000`}
        />
        ...
        >
          <img
            ...
            style={{
              maskImage:
                "linear-gradient(to bottom, black 50%, transparent 95%), radial-gradient(circle at center top, black 50%, transparent 100%)",
              WebkitMaskImage:
                "linear-gradient(to bottom, black 50%, transparent 95%), radial-gradient(circle at center top, black 50%, transparent 100%)",
        ...
        <div className="absolute bottom-[-120px] left-[-10%] right-[-10%] h-[300px] transform translate-z-[100px]">
      ...
      {/* Alpha mat behind chat area (starts lower for a smoother blend) */}
      <div
        className="absolute inset-x-0 bottom-0 z-15 pointer-events-none"
        style={{
          top: "50%",
          background:
            "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.28) 30%, rgba(0,0,0,0.78) 70%, rgba(0,0,0,0.95) 100%)",
        }}
      />

      {/* Cinematic Overlays */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_20%,rgba(0,0,0,0.4)_100%)] pointer-events-none z-10" />

      {/* Floating Dust Particles */}
      <div className="absolute inset-0 opacity-[0.05] pointer-events-none z-20 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] mix-blend-screen animate-pulse" />
    </div>
  );
};
